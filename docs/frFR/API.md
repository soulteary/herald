...
Herald prend en charge deux méthodes d'authentification :

1. **Clé API** (Simple) : Définir l'en-tête `X-API-Key`
...
- `service` : Identifiant de service (par exemple, "stargate")
