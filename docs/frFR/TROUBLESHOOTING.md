...
2. **Vérifier la Configuration du Fournisseur**
   ...
   - Vérifier la configuration SMS : `SMS_PROVIDER`, `SMS_API_BASE_URL`, `SMS_API_KEY` (Herald utilise le mode API HTTP ; les identifiants sont détenus par la passerelle SMS, pas Herald).
